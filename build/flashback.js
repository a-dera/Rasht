...
//dans dans chaque choix on peut faire retour, donc retour à fonc intégration  pour refaire un autre choix
 var sup2 = function(){
   ...
   var droits = function(){
    ...
    Vue.use(Toasted)
    Vue.toasted.show('<div class="control"><div class="tags has-addons"><span class="tag is-primary is-light">Rasht</span><span class="tag is-info is-light">V0.0.1</span></div></div><span class="tag is-info is-rounded">Proposé par A. DERA<span>',{
      theme: "outline", 
      position: "top-center", 
      duration : 3000
    });
